...
from parse_data import parse, parse_APD, drug_dictionary

drug_cmax = drug_dictionary()#{'AZ': 1.937, 'CQ': 0.41, 'HAL': 0.57, 'HCQ': 1.22, 'MOX': 4.111, 'QUIN': 3.9567, 'HCQ_AZ': 1.22 , 'HCQ_HAL': 1.22, 'HCQ_MOX': 1.22, 'LOP_RIT': 0.704}
...
# plt.semilogx(c_hcq, am_hcq, color=cmap(3))
# ax1.fill_between(c_hcq, al_hcq, ah_hcq, facecolor=cmap(3), edgecolor=None, alpha=0.2)
...
# plt.plot(t_hcq, v_hcq, color=cmap(3), label='HCQ')
...
axes.set_xlim([-5, 805])
plt.plot(t_cont, v_cont, color='silver', label='Control')
plt.plot(t_az2, v_az2, color=cmap(0), label='AZ')
plt.plot(t_cq2, v_cq2, color=cmap(1), label='CQ')
plt.plot(t_hal2, v_hal2, color=cmap(2), label='HAL')
# plt.plot(t_hcq2, v_hcq2, color=cmap(3), label='HCQ')
plt.plot(t_lrit2, v_lrit2, color=cmap(3), label='LOP/RIT')
plt.plot(t_mox2, v_mox2, color=cmap(4), label='MOX')
plt.plot(t_qnn2, v_qnn2, color=cmap(5), label='QUIN')
...
axes.set_xlim([-5, 805])
plt.plot(t_cont, v_cont, color='silver', label='Control')
plt.plot(t_hcq2, v_hcq2, color=cmap(0), label='HCQ')
plt.plot(t_az2, v_az2, color=cmap(1), label='AZ')
plt.plot(t_haz2, v_haz2, color=cmap(2), label='HCQ/AZ')
...
plt.plot(t_cont, v_cont, color='silver', label='Control')
plt.plot(t_hcq2, v_hcq2, color=cmap(0), label='HCQ')
plt.plot(t_hal2, v_hal2, color=cmap(1), label='HAL')
plt.plot(t_hhal2, v_hhal2, color=cmap(2), label='HCQ/HAL')
...
plt.plot(t_cont, v_cont, color='silver', label='Control')
plt.plot(t_hcq2, v_hcq2, color=cmap(0), label='HCQ')
plt.plot(t_mox2, v_mox2, color=cmap(1), label='MOX')
plt.plot(t_hmox2, v_hmox2, color=cmap(2), label='HCQ/MOX')
